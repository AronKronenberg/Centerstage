...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -4.5; // X is the up and down direction
    ...
    public static double X_MULTIPLIER = 1.0485633198; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.9907541313; // Multiplier in the Y direction
