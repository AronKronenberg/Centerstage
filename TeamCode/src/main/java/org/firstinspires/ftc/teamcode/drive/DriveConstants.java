...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 16.97; // 16.34; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.0165; //1.0 / rpmToVelocity(MAX_RPM);
    public static double kA = 0.002; //0;
    public static double kStatic = 0.015; //0;
     ...
     */
    public static double MAX_VEL = 58.193875674; //52.48180821614297;
    public static double MAX_ACCEL = 52.48180821614297;
    public static double MAX_ANG_VEL = Math.toRadians(172.17150172947618); //Math.toRadians(184.02607784577722);
